<%@ Page Language="C#" MasterPageFile="AdminHeader.Master" AutoEventWireup="true" CodeBehind="ViewAdmin.aspx.cs" Inherits="testing.ViewAdmin" %>
   ...
   <style>
    ...
    <div id="addAdminForm">
        ...
        <div class="ViewAdminForm">
            ...
            <br />
            <asp:Button ID="btnDone" runat="server" Text="Done" CssClass="btnStyleCss" PostBackUrl="~/AdminCRUD.aspx" />
        </div>
    </div>
</asp:Content>