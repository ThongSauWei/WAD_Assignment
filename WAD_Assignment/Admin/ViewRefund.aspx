<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewRefund.aspx.cs" Inherits="WAD_Assignment.Admin.ViewRefund" %>
   ...
   <style>
    ...
    <div id="refundForm">
        ...
        <div class="ViewRefundForm">
            ...
            <br />
            <asp:Button ID="btnAccept" runat="server" Text="Update" CssClass="btnStyleCss" OnClientClick="redirectToUpdatePage()" PostBackUrl="~/Admin/Update.aspx" />
            <asp:Button ID="btnReject" runat="server" Text="Done" CssClass="btnStyleCss" PostBackUrl="~/Admin/AdminCRUD.aspx" />
        </div>
    </div>
</asp:Content>