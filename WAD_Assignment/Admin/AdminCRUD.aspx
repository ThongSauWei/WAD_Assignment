...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <h3>Which admin do you want to amend?</h3><br />
            <asp:Button ID="btnAddAdmin" runat="server" Text="Add Admin" CssClass="btnAddCss" PostBackUrl="~/Admin/AddAdmin.aspx" OnClick="btnAddAdmin_Click" />
                    ...
                    <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>&nbsp;&nbsp;
                <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btnStyleCss" PostBackUrl='<%# "~/Admin/UpdateAdmin.aspx?staffID=" + Eval("staffID") %>' />
                &nbsp;&nbsp;
                ...
                &nbsp;&nbsp;
                <asp:Button ID="btnView" runat="server" Text="View" CssClass="btnStyleCss" PostBackUrl='<%# "~/Admin/ViewAdmin.aspx?staffID=" + Eval("staffID") %>' /></td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            </table>
