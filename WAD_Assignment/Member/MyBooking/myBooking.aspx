    ...
    <div class="mybooking-container">
        ...
        <article class="card">
            ...
            <div class="card_content">
                ...
                <asp:HyperLink class="refund-btn" runat="server" NavigateUrl="~/Member/MyBooking/BookingDetail.aspx">
                    View More
                </asp:HyperLink>
            </div>
        </article>
        ...
        <article class="card card-old">
            <img
                ...
                height="270" />
            <div class="card_content">
                <h3>Ant-Man and the Wasp: Quantumania
                </h3>
                <p>
                    HallNo : 10 
                </p>
